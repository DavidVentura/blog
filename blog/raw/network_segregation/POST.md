...
---
After adding a [fancy router](/posts/network-update-part-1-custom-router-with-espressobin) to my setup and adding some [monitoring](/posts/network-update-part-2-monitoring-the-network-with-netflow-influxdb-and-grafana) I decided I could segregate my network, as the current state was just bunching everything on the common VLAN.
