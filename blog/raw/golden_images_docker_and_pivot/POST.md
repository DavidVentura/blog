...
I investigated [before](/posts/creating-a-golden-centos-image) how to generate and flash custom OS images, and we can keep building
...
With the container data we want to put on disk, we have to do the same as in [this post](/posts/creating-a-golden-centos-image) so I will just list the
