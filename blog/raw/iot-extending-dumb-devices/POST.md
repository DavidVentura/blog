...
---
As with my [kindle hack](/posts/integrating-a-kindle-into-house-automation/), I wanted to extend a 'dumb' device, my HDMI input selector.
...
As this device (Odroid) has a very limited linux runtime, I setteld on sending UDP messages (same as the [kindle](/posts/integrating-a-kindle-into-house-automation/)) to a local server that converts them to MQTT.
